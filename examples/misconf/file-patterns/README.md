...
```bash
$ tunnel conf --severity HIGH,CRITICAL configs
...
```bash
$ tunnel conf --file-patterns "dockerfile:.*.docker" --file-patterns "yaml:deployment" configs
tunnel conf --severity HIGH,CRITICAL --file-patterns "dockerfile:.*.docker" --file-patterns "yaml:deployment" configs
