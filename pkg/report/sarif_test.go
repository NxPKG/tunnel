			...
			wantRules: []*sarif.ReportingDescriptor{
				{
					...
					HelpURI: toPtr("https://avd.khulnasoft.com/nvd/cve-2020-0001"),
			...
			wantRules: []*sarif.ReportingDescriptor{
				{
					...
					HelpURI: toPtr("https://avd.khulnasoft.com/appshield/ksv001"),
					Properties: map[string]interface{}{
						"tags": []interface{}{
							"misconfiguration",
							"security",
				...
				},
				{
					...
					HelpURI: toPtr("https://avd.khulnasoft.com/appshield/ksv002"),
					Properties: map[string]interface{}{
						"tags": []interface{}{
							"misconfiguration",
							"security",
