	...
	for !in.IsDelim('}') {
		...
		case "DataSource":
			if in.IsNull() {
				...
				easyjson6601e8cdDecodeGithubComKhulnasoftTunnelDbPkgTypes(in, out.DataSource)
			}
		case "Custom":
		...
		case "CVSS":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					in.WantColon()
					var v40 types2.CVSS
					easyjson6601e8cdDecodeGithubComKhulnasoftTunnelDbPkgTypes1(in, &v40)
					(out.CVSS)[key] = v40
					in.WantComma()
				}
				in.Delim('}')
...
func easyjson6601e8cdEncodeGithubComKhulnasoftTunnelPkgTypes(out *jwriter.Writer, in types.DetectedVulnerability) {
	...
	if in.DataSource != nil {
		...
		easyjson6601e8cdEncodeGithubComKhulnasoftTunnelDbPkgTypes(out, *in.DataSource)
	}
	if in.Custom != nil {
	...
	if len(in.CVSS) != 0 {
		...
		}
		{
			...
			for v47Name, v47Value := range in.CVSS {
				...
				out.RawByte(':')
				easyjson6601e8cdEncodeGithubComKhulnasoftTunnelDbPkgTypes1(out, v47Value)
			}
			out.RawByte('}')
		}
	}
...
func easyjson6601e8cdDecodeGithubComKhulnasoftTunnelDbPkgTypes1(in *jlexer.Lexer, out *types2.CVSS) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComKhulnasoftTunnelDbPkgTypes1(out *jwriter.Writer, in types2.CVSS) {
	out.RawByte('{')
	first := true
	_ = first
	if in.V2Vector != "" {
...
func easyjson6601e8cdDecodeGithubComKhulnasoftTunnelDbPkgTypes(in *jlexer.Lexer, out *types2.DataSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComKhulnasoftTunnelDbPkgTypes(out *jwriter.Writer, in types2.DataSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
	...
	if len(in.Locations) != 0 {
		...
		}
		{
			...
			for v57, v58 := range in.Locations {
				...
				easyjson6601e8cdEncodeGithubComKhulnasoftTunnelPkgFanalTypes8(out, v58)
			}
			out.RawByte(']')
		}
	}
		...
		case "CustomResources":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson6601e8cdDecodeGithubComKhulnasoftTunnelPkgModuleSerialize5(in, &v65)
	...
	_ = first
	{
		...
		if in.CustomResources == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v66, v67 := range in.CustomResources {
				...
				easyjson6601e8cdEncodeGithubComKhulnasoftTunnelPkgModuleSerialize5(out, v67)
			}
			out.RawByte(']')
		}
	}
